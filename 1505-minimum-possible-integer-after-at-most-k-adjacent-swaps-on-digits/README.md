...
<pre style="position: relative;"><strong>Input:</strong> num = "4321", k = 4
...
<pre style="position: relative;"><strong>Input:</strong> num = "100", k = 1
...
<pre style="position: relative;"><strong>Input:</strong> num = "36789", k = 1000
